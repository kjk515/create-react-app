...
const commonProperties =
  fs.existsSync(paths.commonProperties) && require(paths.commonProperties);
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        ...(commonProperties.alias &&
          Object.entries(commonProperties.alias).reduce(
            (prev, [name, path]) => ({
              ...prev,
              [name]: `${paths.appPath}/${path}`,
            }),
            {}
          )),
      },
          ...
          use: [
            {
              options: {
                ...
                baseConfig: {
                  extends: [require.resolve('@mes/eslint-config-mes')],
                },
                useEslintrc: false,
                // @remove-on-eject-end
              },
        ...
        },
        {
          ...
          oneOf: [
            ...
            // A missing `test` is equivalent to a match.
            {
              ...
              options: {
                limit: 10000,
                name: 'res/media/[name].[hash:8].[ext]',
              },
            },
            // 앱 내의 JS를 위한 바벨로더
            ...
            // The preset includes JSX, Flow, TypeScript, and some ESnext features.
            {
              ...
              options: {
                ...
                plugins: [
                  ...
                  'react-docgen', // 컴포넌트 문서 생성
                  // ["@babel/plugin-proposal-decorators", { "legacy": true }], // decorator 사용
                  // ["@babel/plugin-proposal-class-properties", { "loose": true }], // class static 속성 사용
                  // "react-docgen", // 컴포넌트 문서 생성
                ],
    ...
    externals: [nodeExternals({ whitelist: [/\.(sa|sc|le|c)ss$/] })],
  };
};
